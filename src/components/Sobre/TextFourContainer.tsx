...
<div className="absolute top-0  left-0 right-0 h-64 bg-gradient-to-b from-black via-black/50 to-transparent z-10"></div>

<div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-t from-black via-black/50 to-transparent z-10"></div>
    {/* Botão */}
    <div className="flex justify-between h-full items-end flex-col w-full gap-2 z-20">
    
       <motion.p
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.2 }}
        className="text-white text-xs md:text-xs font-body font-light tracking-base px-4 text-right"
      >
        {"Nosso propósito é celebrar essa paixão universal. Mais do que produtos excepcionais, criamos memórias, aventuras e momentos que ficam para sempre. A Zaylo é um movimento que une pessoas que reconhecem o valor da amizade leal e da companhia inabalável dos cães."}
      </motion.p>  
      ...
      >
        {"Escolhemos o Rio de Janeiro como ponto de partida, onde Brasil, pessoas e cachorros se encontram, para mostrar ao mundo o verdadeiro motivo da nossa existência: os cães nos tornam mais humanos."}
      </motion.p>  
    </div>
